...
let startApp = () => {
    ...
    document.querySelector('.data-hoje')
       ...
       ul.innerHTML += `<li> ${inputTarefa.value}<span class="data-hoje"> ${date.toLocaleDateString()}</span> <label for="">Data limite: ${data}</label> <input type="checkbox" name="completed" class="completed"/> <input class= "Excluir" type="button" value="Excluir"/></li>`
